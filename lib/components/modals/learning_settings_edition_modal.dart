...
// TODO: nadać możliwość edycji bloków - do zrobienia! wymmiana w bazie danych
class LearningSettingsEditionModal extends StatelessWidget {
  Map skillset = {};

  LearningSettingsEditionModal({@required this.skillset});
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: <Widget>[
                ...
                DiagnosedSkillsBlocks(skillset: this.skillset, editMode: true),
